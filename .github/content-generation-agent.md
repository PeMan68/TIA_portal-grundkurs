...
settings:
  language: sv
  structure: headings, bullet points, examples
...
examples:
  - Skriv en introduktion till "Vad är TIA Portal?" med punktlista och länk till officiell video.
  - Skapa en översikt av "Skillnader mellan OB, FB, FC" med tydliga rubriker och exempel.